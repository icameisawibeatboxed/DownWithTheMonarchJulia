...
public class OVRPlayerController : OVRComponent
{
	...
	// Transfom used to point player in a given direction; We should attach objects to this if 
	// we want them to rotate separately from the head (i.e. the body)
	private Transform DirXform = null;
	...
	void UpdatePlayerForwardDirTransform()
	{
	...
	public void InitializeInputs()
	{
		...
		// Make sure to set y rotation to 0
		YRotation = 0.0f;
	}
	...
	public void SetCameras()
	{
		if(CameraController != null)
		{
			...
			CameraController.SetDirectionOffset(Direction);
